#!/usr/bin/env python3
"""
Script to inspect the DEV database and see pending chunks.
...
app = modal.App("inspect-db-dev")

# Use DEV volume and database
...
def inspect_database():
    """Inspect the DEV database and show pending chunks."""
    db = Database("/data/stories-dev.db")

    print("\n" + "="*80)
    print("DEV DATABASE INSPECTION")
    print("="*80)

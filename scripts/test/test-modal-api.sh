...
echo "=================================================="
HEALTH_URL="${MODAL_API_URL}-health-endpoint.modal.run"
echo "GET $HEALTH_URL"
echo ""
...
echo "=================================================="
EXTRACT_URL="${MODAL_API_URL}-extract-content-endpoint.modal.run"
...
echo "=================================================="
CHUNK_URL="${MODAL_API_URL}-chunk-story-endpoint.modal.run"
